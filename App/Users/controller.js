...
module.exports = {
  Create: async (req, res) => {
    try {
        ...
        let message = '';
        message= '<h2 style="font-weight: 700; text-decoration: underline; text-align:center">Account Registered</h2><br>';
        message += `<h3><b>Dear ${name}!</b></h3><br>` +
                `<p>Welcome to TEXENN. We create alliance of market groups. Feel free to place any query.</p>`;
        message += '<br><p><b>Regards:</b></p><br><p>TEXENN</p><br>';

        const msg = {
            to: email,
            from: process.env.SENDER_EMAIL,
            subject: `TEXENN: Welcome ${name}`,
            text: message,
            html: message
        };
